...
<body class="border border-danger">
	<nav class="navbar navbar-dark navbar-expand-sm fixed-top"  style="background-color: #fff">
        <div class="container">
            ...
            <!-- </div>
            <div class="collapse navbar-collapse" id="user" style="padding: 0;"> -->
	...
	<div class="container" style="margin-top: 20%;">
		<form class="border" method="post" style="border: 4px solid white !important">
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="num" name="ut" class="form-control" required>
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-2">
			...
			<div class="form-group row" >
				<div class="col-sm-2">
					<label style="margin-left: 9%;"><b>Required in -</b> </label>
				</div>
				<div class="col-sm-10">
					<input type="radio" name="rd" value="0"> Urgent Requirement &nbsp;&nbsp; <input type="radio" name="rd" value="2"> 2 Days &nbsp;&nbsp; <input type="radio" name="rd" value="3">  3 Days
				</div>
			</div>
			...
			<div class="form-group row">
				<button type="submit" class="btn btn-danger" name="add" style="margin: 0 2.9%;">Request for Blood</button>
