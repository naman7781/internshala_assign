...
if ( isset($_POST['add']) && is_numeric($_POST['num'])){
    ...
    $stmt = $pdo->prepare('INSERT INTO hospital
        (hospital_name,name,contact_no,email,password) VALUES ( :bg, :nm, :cn, :em, :ps)');
    $stmt->execute(array(
        ':bg' => htmlentities($_POST['hnm']),
	...
	<div class="container" style="margin-top: 20%;">
		<form class="border" method="post"  style="border: 4px solid white !important">
			<div class="form-group row">
				<div class="col-sm-2">
					<label for="hnm"> <b>Hospital Name</b></label>
				</div>
				<div class="col-sm-3">
					<input type="text" name="hnm" class="form-control" required>
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-2">
			...
			<div class="form-group row">
				<div class="col-sm-2">
					<label for="num" style="margin-left: 9%;"><b>Contact No.</b></label>
				</div>
				<div class="col-sm-3">
			...
			<div class="form-group row">
				...
				<div class="col-sm-4">
					<label class="agp">(A password must be of length between 8-20 and must contain one digit and one alphabet.)</label>
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-2">
